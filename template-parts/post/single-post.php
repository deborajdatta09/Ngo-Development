...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="box-content">
        ...
        <?php if(get_theme_mod('ngo_organization_remove_category',true) != ''){ 
            if(has_category()){ 
        ...
        <?php if( get_theme_mod( 'ngo_organization_remove_comment',true) != ''){ 
    ...
    <?php if( get_theme_mod( 'ngo_organization_remove_related_post',true) != ''){  ?>

...
$ngo_organization_post_args = array(
    'posts_per_page'    => '3',
    'orderby'           => 'rand',
...
$ngo_organization_ids = array();
foreach( $related as $term ) {
    $ngo_organization_ids[] = $term->term_id;
}

$ngo_organization_post_args['category__in'] = $ngo_organization_ids; 

$related_posts = new WP_Query( $ngo_organization_post_args );

if ( $related_posts->have_posts() ) : ?>
        <div class="related-post-block">
        <h3 class="text-center mb-3"><?php esc_html_e('Related Posts','ngo-organization'); ?></h3>
        <div class="row">
                        ...
                        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                            <div class="page-box">
                                ...
                                <div class="box-content text-center">
                                    ...
                                    <p><?php echo wp_trim_words(get_the_content(), get_theme_mod('ngo_organization_excerpt_count',10) );?></p>
